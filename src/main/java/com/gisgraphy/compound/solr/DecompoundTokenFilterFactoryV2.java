...
public class DecompoundTokenFilterFactoryV2 extends BaseTokenFilterFactory implements ResourceLoaderAware {
    ...
    public TokenStream create(TokenStream tokenStream) {
        return new DecompoundTokenFilterV2(tokenStream, decompounder);
    }
